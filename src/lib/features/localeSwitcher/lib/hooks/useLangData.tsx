...
import ByIcon from '@/common/assets/lang/ByIcon';
import GbIcon from '@/common/assets/lang/GbIcon';
import KzIcon from '@/common/assets/lang/KzIcon';
import RuIcon from '@/common/assets/lang/RuIcon';
import UaIcon from '@/common/assets/lang/UaIcon';
